...
@app.post("/CreateUser")
def create_user(user: BaseModel.ModelUser.CreateUser):
...
@app.post("/list")
def addMovieCollection(createList: BaseModel.ModelList.CreateList):
    return dbConnection.createMovielist(createList)
...
def getWatchlist(userid: str):
    return dbConnection.getWatchlist(userid)


@app.post("/account/{userid}/watchlist/{movieID}")
def addWatchlist(userid: str, movieID: int):
    return dbConnection.addMovieToWatchlist(userid, movieID)


@app.get("/account/reviews/{userid}")
def getReviews(userid: str):
    return dbConnection.getMovieReviewByUserID(userid)
